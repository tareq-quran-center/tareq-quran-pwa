-- ==========================================================
-- Migration: 20260925120000_fix_student_transfer_and_admin_rls.sql
-- Description: Allow center admin to safely transfer and manage students,
--              fix RLS policies and foreign keys between circles & groups.
-- ==========================================================
