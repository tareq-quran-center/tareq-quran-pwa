...
export function calculateStudentBadges(
  ...
  const badges: StudentBadge[] = [
    ...
    },
    {
      ...
      title: "حافظ متميز",
      icon: "🚀",
      color: "text-burgundy-700 border-burgundy-300 dark:border-burgundy-700",
      bgGradient: "from-burgundy-500/20 via-burgundy-400/10 to-burgundy-500/5",
    ...
    },
    {
      ...
      title: "بداية مباركة",
      icon: "🌱",
      color: "text-islamicGold-600 border-islamicGold-300 dark:border-islamicGold-700",
      bgGradient: "from-islamicGold-500/20 via-islamicGold-400/10 to-islamicGold-500/5",
